...
class User{
    ...
    */
    ...
    /**
    * Template for landing top function
    * @return void.
    */
    public function landingTop() {
        print $this->render(landingTop);
    }
    ...
    */
    ...
    /**
    * Template for lLANDING middle function
    * @return void.
    */
    public function landingMiddle() {
        print $this->render(landingMiddle);
    }
    ...
    */
    ...
    /**
    * Template for landing footer function
    * @return void.
    */
    public function landingFooter() {
        print $this->render(landingFooter);
    }
    ...
    */
    public function indexFooter() {
     ...
     /**
    * Template for ARTICLE Creation Screen footer function
    * @return void.
    */
    public function articleFooter() {
        print $this->render(articleFooter);
    }
    /**
